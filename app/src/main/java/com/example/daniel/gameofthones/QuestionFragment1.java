...
public class QuestionFragment1 extends Fragment implements View.OnClickListener  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
         View view = inflater.inflate(R.layout.fragment_question_fragment1, container, false);
        questionTitle = (TextView)view.findViewById(R.id.question1);
        nextQuestion = (TextView)view.findViewById(R.id.next_1);
        ...
        mListener.getPageTitle("Question 1");
