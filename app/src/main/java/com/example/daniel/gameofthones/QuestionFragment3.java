 ...
 */
public class QuestionFragment3 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_question_fragment3, container, false);
        questionTitle = (TextView) view.findViewById(R.id.question1);
        nextQuestion = (TextView) view.findViewById(R.id.next_3);
        ...
        mListener.getPageTitle("Question 3");
