 ...
 */
public class QuestionFragment2 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_question_fragment2, container, false);
        questionTitle = (TextView)view.findViewById(R.id.question1);
        nextQuestion = (TextView)view.findViewById(R.id.next_2);
        ...
        mListener.getPageTitle("Question 2");
    ...
    public void onClick(View v) {
        ...
        if(correctAnswer == -1){
            ...
            if (correctAnswer == answer_3.getId()) {
                proba = "tacno";
            } else {
                proba = "netacno";
            }
